...
from openapi_server.models.suggestion_item import SuggestionItem
try:
...
class SuggestResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "suggestions": [SuggestionItem.from_dict(_item) for _item in obj.get("suggestions")] if obj.get("suggestions") is not None else None
        })
        return _obj
