...
from openapi_server.apis.movies_public_api_base import BaseMoviesPublicApi
...
async def get_movies_api_v1_movies_get(
    ...
    if not BaseMoviesPublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMoviesPublicApi.subclasses[0]().get_movies_api_v1_movies_get(page, page_size, search)
...
async def get_movie_api_v1_movies_movie_id_get(
    ...
    if not BaseMoviesPublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMoviesPublicApi.subclasses[0]().get_movie_api_v1_movies_movie_id_get(movie_id)
